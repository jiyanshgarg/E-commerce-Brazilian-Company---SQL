# Brazilian e-commerce SQL Analysis: Customer & Order Insights for Business Growth
Analysed 100k+ orders from a Brazilian marketplace using SQL: derived top customer segments, revenue drivers, and recommendations for retention.
